...
- Migrations **v29–v40** applied on PostgreSQL 16.
...
- **Business logos** (`business-logos` bucket, v38): public SELECT; writes require admin + folder `[1] = current_business_id()`. Not covered by the SQL isolation harness.
