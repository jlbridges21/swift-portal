...
const SERVICE_ROLE_ALLOWLIST = new Set([
  ...
  "src/app/api/cron/google-calendar/route.ts",
  ...
  "src/app/api/platform/businesses/[id]/restore/route.ts",
  "src/app/platform/lifecycle-emails/page.tsx",
  ...
  "src/lib/platform-revenue.ts",
  "src/app/api/platform/revenue/subscriptions/route.ts",
  "src/app/api/platform/revenue/client-payments/route.ts",
  ...
  "src/lib/partner-referral-discount.ts",
  "src/lib/sync-referral-discount-stripe-coupons.ts",
  "src/lib/partner-landing.ts",
