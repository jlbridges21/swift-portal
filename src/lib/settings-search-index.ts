...
const FIELD_ENTRIES: Omit<SettingsSearchEntry, "href">[] = [
  ...
  {
    id: "media-section-defaults",
    sectionId: "new_project_setup",
    label: "Client media sections",
    description: "Defaults for which media sections new projects show to clients.",
    keywords: [
      "sections",
      "defaults",
      "photos",
  ...
  },
  {
    ...
    keywords: ["integrations", "ghl", "gohighlevel", "google calendar", "calendar"],
  },
  {
    id: "automated_emails",
  ...
  },
  {
    ...
    description: "Invite teammates and permission matrix.",
    keywords: [
      "staff",
      "permissions",
      "team",
  ...
  {
    id: "instant-preliminary",
    sectionId: "services",
    label: "Instant preliminary estimate",
    description: "Show a ballpark estimate on the public request form.",
    keywords: [
      "instant preliminary",
      "preliminary estimate",
      "instant estimate",
  ...
  },
  {
    id: "hero-media",
    sectionId: "landing",
    label: "Hero media and overlay",
    description: "Landing hero showreel, image, and contrast overlay.",
    keywords: [
      "hero media",
      "hero",
      "showreel",
  ...
  },
  {
    ...
    sectionId: "branding",
    label: "Logo size",
    description: "Portal nav logo height.",
    keywords: [
      "logo size",
      "logo height",
      "nav logo",
  ...
  {
    id: "landing-logo-size",
    sectionId: "landing",
    label: "Landing logo size",
    description: "Public landing header logo height.",
    keywords: [
      "landing logo size",
      "landing logo",
      "header logo",
  ...
  },
  {
    ...
    description: "Landing header and hero background colors.",
    keywords: [
      "landing colors",
      "landing colour",
      "header color",
  ...
  },
  {
    ...
    description: "Which media sections clients see on new projects (defaults).",
    keywords: [
      "section visibility",
      "client sections",
      "hide section",
  ...
  {
    id: "3d-models-defaults",
    sectionId: "new_project_setup",
    label: "3D models",
    description: "Default visibility for 3D / Polycam / Sketchfab model sections.",
    keywords: [
      "3d models",
      "3d",
      "models",
  ...
  },
  {
    ...
    description: "Clients choose original or compressed when downloading media.",
    keywords: [
      "download quality",
      "compressed download",
      "original download",
...
const HASH_BY_ENTRY: Record<string, string> = {
  ...
  new_project_setup: "settings-new-project-setup",
  "media-section-defaults": "settings-media-section-defaults",
  "section-visibility": "settings-media-section-defaults",
  "3d-models-defaults": "settings-media-section-defaults",
  "download-quality": "settings-download-gate",
  "instant-preliminary": "settings-instant-preliminary",
  "hero-media": "settings-hero-media",
  "logo-size": "settings-logo-size",
  "landing-logo-size": "settings-landing-logo-size",
  "landing-colors": "settings-landing-colors",
