...
export default async function BillingPage() {
  ...
  const headline = sub.requiresPayment
  ...
  const description = sub.requiresPayment
  ...
  return (
    <BrandProvider brand={brand}>
      ...
      <div className="min-h-screen bg-background">
        {/* Minimal chrome: no NotificationBell / messages APIs (those 402 when paywalled). */}
