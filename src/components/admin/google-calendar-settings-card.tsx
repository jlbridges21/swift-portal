...
export function GoogleCalendarSettingsCard() {
  ...
  async function saveCalendar() {
    ...
    setMessage(`ShootPortal will write to ${data.calendarSummary || "that calendar"}.`);
    await load();
  }
      ...
      <CardContent className="space-y-4 pt-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            ...
            (one hour). External Google events are not imported in this phase.
          </p>
        </div>
        ...
        {status?.connected ? (
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <Label htmlFor="gcal-calendar">Calendar</Label>
              <select
                id="gcal-calendar"
              ...
              <p className="text-xs text-muted">
                Defaults to the primary calendar at connect. Change it here if ShootPortal should write somewhere else.
              </p>
            </div>
