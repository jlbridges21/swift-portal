...
export function LoggedInRequestForm({
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10">
        <Card>
          <CardHeader>
            <CardTitle>{inquiryMode ? "Send an Inquiry" : "Request a New Project"}</CardTitle>
            <CardDescription>
              {inquiryMode
                ? "Tell us about your property — your inquiry will appear in your portal immediately."
