...
BEGIN
  ...
  DELETE FROM project_staff WHERE business_id = v_teardown_business_id;
  ...
  DELETE FROM partners WHERE id = '00000000-0000-0000-0000-0000000000d0';
  ...
  DELETE FROM project_shares WHERE business_id = v_pentest_business_id;
  DELETE FROM project_staff WHERE business_id = v_pentest_business_id;
