...
FROM unnest(ARRAY[
  ...
  'trg_video_reviews_project_id_same_business',
  'trg_video_review_versions_review_id_same_business',
  'trg_video_review_versions_media_asset_id_same_business',
  'trg_video_review_comments_review_id_same_business',
  'trg_video_review_comments_version_id_same_business',
  'trg_video_review_comments_project_id_same_business',
  'trg_video_review_comments_parent_comment_id_same_business',
